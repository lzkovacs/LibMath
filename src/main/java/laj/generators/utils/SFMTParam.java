...
public enum SFMTParam {
    ...
    /**
     * N32 is the size of an internal state array when regarded as an array of 32-bit integers.
     */
    public final int SFMT_N32;

    /**
     * N64 is the size of an internal state array when regarded as an array of 64-bit integers.
     */
